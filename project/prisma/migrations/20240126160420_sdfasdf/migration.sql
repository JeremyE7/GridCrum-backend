...
INSERT INTO "new_Item" ("audioId", "boardId", "h", "i", "id", "imgId", "linkId", "projectId", "reminderId", "taskId", "typeId", "videoId", "w", "x", "y") SELECT "audioId", "boardId", "h", "i", "id", "imgId", "linkId", "projectId", "reminderId", "taskId", "typeId", "videoId", "w", "x", "y" FROM "Item";
DROP TABLE "Item";
